...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
	<a class="navbar-brand" href="register.jsp"><i class="fas fa-phone"></i>PhoneBook</a>
	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		...
		<form class="form-inline my-2 my-lg-0">
			<a href="login.jsp" class="btn btn-success"><i
				class="fas fa-user mr-2"></i>Login</a> <a href="register.jsp"
				class="btn btn-danger ml-2"><i class="fas fa-user mr-2"></i>Register</a>
		</form>
